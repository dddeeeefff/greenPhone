...
<link rel="stylesheet" href="/greenPhone/src/css/inc_head.css">
<script src="/greenPhone/src/js/jquery-3.6.1.js"></script>
<script>
...
<% } %>
		...
		<div class="header">
			<a class="logo" href="index"><img src="/greenPhone/src/img/greenLogo.png" width="150" /></a>
			<ul class="menu">
				<li><a href="product_list">내 폰 사기</a></li>
				<li><a href="sell_index">내 폰 팔기</a></li>
				<li><a href="sell_chart.jsp">시세</a></li>
