...
%>
			...
			<tr align="center" height="80">
				<td width="22%">
					...
					<img src="/greenPhone/buy/pdt_img/<%=sc.getPi_img1() %>" width="50" height="63" style="width:33%" />
				</td>
				<td width="17%">
...
%>
		...
		<p class="tPrice" align="right" style="font-size:0.7em; ">총&nbsp;<%=formatter.format(total) %>원</p>
		<br />
