...
if (!buyInfo.getBi_rank().equals(""))		rank = buyInfo.getBi_rank();
...
%>
		<link rel="stylesheet" href="/greenPhone/src/css/sell_view.css">
		<script>
	        ...
	        <div class="content-wrapper">
	            ...
	            <div class="content-info">
	                <div class="steps">
	                    <div class="step">
	                        <figure>
	                            <img src="/greenPhone/src/img/sell_register.jpg" alt="register" />
	                        </figure>
	                        <p class="txt <% if (status.charAt(0) >= 'a' || !status.equals("b") || !status.equals("c")) { %>active-txt <% } %>">판매 신청</p>
	                    </div>
	                    <div class="step-arrow">
	                        <figure>
	                            <img src="/greenPhone/src/img/right_arrow.png" alt="arrow" />
	                        </figure>
	                    </div>
	                    <div class="step">
	                        <figure>
	                            <img src="/greenPhone/src/img/sell_inspect.jpg" alt="inspect1" />
	                        </figure>
	                    ...
	                    <div class="step">
	                        <figure>
	                            <img src="/greenPhone/src/img/sell_ship.jpg" alt="ship" />
	                        </figure>
	                    ...
	                    <div class="step">
	                        <figure>
	                            <img src="/greenPhone/src/img/sell_inspect.jpg" alt="inspect2" />
	                        </figure>
	                    ...
	                    <div class="step">
	                        <figure>
	                            <img src="/greenPhone/src/img/sell_done.jpg" alt="done" />
	                        </figure>
	                ...
	                <div class="info">
	                    <div class="imgs">
	                        <div class="img-row">
	                            <figure>
	                                <img src="/greenPhone/sell/upload/<%=buyInfo.getBi_img1() %>" alt="img1" />
	                            </figure>
	                            <figure>
	                                <img src="/greenPhone/sell/upload/<%=buyInfo.getBi_img2() %>" alt="img2" />
	                            </figure>
	                        </div>
	                        <div class="img-row">
	                            <figure>
	                                <img src="/greenPhone/sell/upload/<%=buyInfo.getBi_img3() %>" alt="img3" />
	                            </figure>
	                            <figure>
	                                <img src="/greenPhone/sell/upload/<%=buyInfo.getBi_img4() %>" alt="img4" />
	                            </figure>
	                        </div>
	                    </div>
	                    <div class="texts">
