...
public class BbsEvent {
	private int be_idx, ai_idx, be_read;
	private String be_title, be_content, be_img, be_isview, be_sdate, be_edate, be_date;
	...
	public int getBe_read() {
		return be_read;
	}
	public void setBe_read(int be_read) {
	...
	public void setBe_img(String be_img) {
		this.be_img = be_img;
	}
