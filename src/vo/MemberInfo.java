...
public class MemberInfo {
	private String mi_id, mi_pw, mi_name, mi_gender, mi_birth, mi_phone, mi_email;
	private String mi_zip, mi_addr1, mi_addr2, mi_joindate, mi_status;
	...
	public String getMi_zip() {
		return mi_zip;
	}
	public void setMi_zip(String mi_zip) {
		this.mi_zip = mi_zip;
	}
